...
class CreditCardLoanDetails extends StatelessWidget {
  CreditCardLoanDetails({Key? key}) : super(key: key);
  var id;
  @override
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              AppText(
                id["id"] == 1
                    ? AppString.creditCard11
                    : id["id"] == 2
                        ? AppString.creditCard12
                        : id["id"] == 3
                            ? AppString.creditCard13
                            : AppString.creditCard14,
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: AppText(
                      id["id"] == 1
                          ? AppString.creditCard1
                          : id["id"] == 2
                              ? AppString.creditCard2
                              : id["id"] == 3
                                  ? AppString.creditCard3
                                  : AppString.creditCard14,
